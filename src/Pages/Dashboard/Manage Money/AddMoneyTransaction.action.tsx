...
import { addMoneyTransaction } from "../../../Api/MoneyTransaction.API";

const OnAddMoneyTransction = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        await addMoneyTransaction(formData);
        window.history.back();
    };
    ...
    React.useEffect(() => {
        const run = async () => {
            ...
            setFormData({ ...formData, user_id: userdata.data.user_id });
        };
...
export default OnAddMoneyTransction;
